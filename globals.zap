...
?PRG1:	DLESS?	'CNT,0 /TRUE
	...
	.FUNCT	CONTINUE,CURRENTLY-SCRIPTING=0,CNT
	GETB	0,32
	GRTR?	STACK,21 \?CND1
	GETB	0,32
	SUB	STACK,21 >CNT
...
?CND9:	PRINTI	"[Hit any key to continue.]"
	BUFOUT	FALSE-VALUE
	BUFOUT	TRUE-VALUE
	ZERO?	CURRENTLY-SCRIPTING /?CND14
	DIROUT	D-PRINTER-ON
?CND14:	INPUT	1
	RSTACK	
